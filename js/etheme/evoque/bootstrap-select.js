...
!function($) {
    ...
    Selectpicker.prototype = {
        ...
        createDropdown: function() {
            ...
            var header = this.options.header ? '<h4 class="popover-title">' + this.options.header + '<button type="button" class="close" aria-hidden="true">&times;</button></h4>' : '';
        ...
        clickListener: function() {
            ...
            this.$menu.on('click', 'li.disabled a, li dt, li .div-contain, h4.popover-title', function(e) {
                if (e.target == this) {
                    e.preventDefault();
                    e.stopPropagation();
                    that.$button.focus();
