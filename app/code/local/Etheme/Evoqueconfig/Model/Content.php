...
class Etheme_Evoqueconfig_Model_Content extends Mage_Core_Model_Abstract
{
    ...
    {
        parent::__construct();
        $this->data_resources_xml = new Varien_Simplexml_Config(Mage::getBaseDir().'/app/code/local/Etheme/Evoqueconfig/Model/data_resources.xml');
        $this->data_static_blocks_xml = new Varien_Simplexml_Config(Mage::getBaseDir().'/app/code/local/Etheme/Evoqueconfig/Model/data_static_blocks.xml');
    }
