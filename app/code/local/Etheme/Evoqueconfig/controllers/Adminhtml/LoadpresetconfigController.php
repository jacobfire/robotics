...
class Etheme_Evoqueconfig_Adminhtml_LoadpresetconfigController extends Mage_Adminhtml_Controller_Action
{
	public function indexAction()
	{
        ...
        $this->_addContent($this->getLayout()->createBlock('evoqueconfig/adminhtml_loadpresetconfig_edit'));
