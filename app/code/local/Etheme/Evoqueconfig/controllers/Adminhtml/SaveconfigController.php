...
class Etheme_Evoqueconfig_Adminhtml_SaveconfigController extends Mage_Adminhtml_Controller_Action
{
	public function indexAction()
	{
        ...
        $this->_addContent($this->getLayout()->createBlock('evoqueconfig/adminhtml_saveconfig_edit'));
